...
export interface LayerConfig {
  ...
  slotManualWidthEnabled?: boolean;
  slotBridgeCrossMainManualWidthEnabled?: boolean;
  slotBridgeCrossMainManualWidth?: number;
  slotBridgeCrossTipInManualWidthEnabled?: boolean;
  slotBridgeCrossTipInManualWidth?: number;
  slotBridgeTiltMainManualWidthEnabled?: boolean;
  slotBridgeTiltMainManualWidth?: number;
  slotBridgeTiltExtensionManualWidthEnabled?: boolean;
  slotBridgeTiltExtensionManualWidth?: number;
  slotWidthCrossMainOffsetEnabled?: boolean;
  slotWidthCrossMainOffset?: number;
  slotWidthCrossTipInOffsetEnabled?: boolean;
  slotWidthCrossTipInOffset?: number;
  slotWidthTiltMainOffsetEnabled?: boolean;
  slotWidthTiltMainOffset?: number;
  slotWidthTiltExtensionOffsetEnabled?: boolean;
  slotWidthTiltExtensionOffset?: number;
